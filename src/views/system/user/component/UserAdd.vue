<template>
  <el-dialog :show-close="false" :close-on-click-modal="false" title="添加用户" :visible.sync="dialogFormVisible" width="40%">
    <el-form :model="form" :rules="rules" ref="form">
      ...
      <el-form-item label="角色" prop="roles" :label-width="formLabelWidth">
        <el-select multiple v-model="form.roles" placeholder="请选择角色" @change="roleSelectChangeHandle">
